    ...
    <div style={{ paddingLeft: 90, paddingRight: 90 }}>
      <div className="container mt-5 search-container">
        ...
        <Container className="mt-4 mb-4">
          <Row xs="auto">
            <Col className="mt-2">Filters:</Col>
            <Col>
              <DropdownButton title="Date">
                <Dropdown.Item id="Date ASC" onClick={handleFilter}>
                  Asc
                </Dropdown.Item>
                <Dropdown.Item id="Date DESC" onClick={handleFilter}>
                  Desc
                </Dropdown.Item>
              </DropdownButton>
            </Col>
            <Col>
              <DropdownButton title="First Name">
                <Dropdown.Item id="First Name ASC" onClick={handleFilter}>
                  Asc
                </Dropdown.Item>
                <Dropdown.Item id="First Name Desc" onClick={handleFilter}>
                  Desc
                </Dropdown.Item>
              </DropdownButton>
            </Col>
            <Col>
              <DropdownButton title="Last Name">
                <Dropdown.Item id="Last Name ASC" onClick={handleFilter}>
                  Asc
                </Dropdown.Item>
                <Dropdown.Item id="Last Name DESC" onClick={handleFilter}>
                  Desc
                </Dropdown.Item>
              </DropdownButton>
            </Col>
            <Col>
              <DropdownButton title="Status">
                <Dropdown.Item id="Status ASC" onClick={handleFilter}>
                  Asc
                </Dropdown.Item>
                <Dropdown.Item id="Status DESC" onClick={handleFilter}>
                  Desc
                </Dropdown.Item>
              </DropdownButton>
            </Col>
