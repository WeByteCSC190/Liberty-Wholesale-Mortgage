      ...
      <Dropdown>
        ...
        <Dropdown.Menu>
          ...
          <Confirmation
            ...
            title="Move To Leads"
            cID={rowData.caseId}
            message="Are you sure you want to move this borrwer to leads  permanently?"
            apiUrl="http://localhost:8000/api/borrowers/"
            rowData={rowData}
          />
        </Dropdown.Menu>
      ...
      <Dropdown>
        ...
        <Dropdown.Menu>
          ...
          <Confirmation
            ...
            title="Move To Borrowers"
            cID={rowData.caseId}
            message="Are you sure you want to move this lead to borrower permanently?"
            apiUrl="http://localhost:8000/api/leads/"
            rowData={rowData}
          />
        </Dropdown.Menu>
      ...
      <Dropdown>
        ...
        <Dropdown.Menu>
          ...
          <Confirmation
            ...
            title="Remove file"
            cID={rowData.id}
            message="Are you sure you want to remove this file permanently?"
            apiUrl="http://localhost:8000/api/files/"
          />
        </Dropdown.Menu>
      </Dropdown>
    );
      ...
      <Dropdown>
        ...
        <Dropdown.Menu>
          ...
          <Confirmation
            ...
            cID={rowData.id}
            message="Are you sure you want to remove this article permanently?"
      ...
      <Dropdown>
        ...
        <Dropdown.Menu>
          ...
          <Confirmation
            ...
            apiUrl="http://localhost:8000/api/media/"
          />
        </Dropdown.Menu>
      </Dropdown>
    );
      ...
      <Dropdown>
        ...
        <Dropdown.Menu>
          ...
          <Confirmation
            ...
            title="Remove Lender"
            cID={rowData.id}
            message="Are you sure you want to remove this Lenders permanently?"
