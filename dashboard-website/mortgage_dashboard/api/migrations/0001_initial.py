# Generated by Django 4.0.3 on 2022-10-06 17:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MileStone',
            fields=[
                ('id', models.IntegerField(default=286050, primary_key=True, serialize=False, unique=True, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.IntegerField(default=245573, unique=True, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=40, null=True, verbose_name='Name')),
                ('desc', models.TextField(blank=True, verbose_name='Description')),
            ],
        ),
        ...
        migrations.CreateModel(
            name='Resources',
            fields=[
                ('id', models.IntegerField(default=361688, primary_key=True, serialize=False, unique=True, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=40, null=True, verbose_name='Name')),
        ...
        migrations.CreateModel(
            name='Lead',
            fields=[
                ('caseId', models.IntegerField(default=961402, primary_key=True, serialize=False, unique=True, verbose_name='Case ID')),
                ('date', models.DateTimeField(verbose_name='Date')),
                ('fName', models.CharField(blank=True, max_length=40, null=True)),
                ('lName', models.CharField(blank=True, max_length=40, null=True)),
                ('creditScore', models.IntegerField(default=381390, unique=True, verbose_name='Credit Score')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cID', models.IntegerField(default=951313, unique=True)),
                ('fName', models.CharField(blank=True, max_length=40, null=True, verbose_name='First Name')),
                ('lName', models.CharField(blank=True, max_length=40, null=True, verbose_name='Last Name')),
                ('email', models.EmailField(max_length=254, verbose_name='Email Address')),
                ('phone_num', models.CharField(max_length=16, null=True, verbose_name='Phone Number')),
        ...
        migrations.CreateModel(
            name='Borrower',
            fields=[
                ('caseId', models.IntegerField(default=755849, primary_key=True, serialize=False, unique=True, verbose_name='Case ID')),
                ('date', models.DateTimeField(verbose_name='Date')),
                ('fName', models.CharField(blank=True, max_length=40, null=True)),
                ('lName', models.CharField(blank=True, max_length=40, null=True)),
                ('creditScore', models.IntegerField(default=836762, unique=True, verbose_name='Credit Score')),
                ('email', models.EmailField(max_length=254, verbose_name='Email Address')),
                ('phone_num', models.CharField(max_length=16, null=True, verbose_name='Phone Number')),
                ('status_check', models.BooleanField(default=False, verbose_name='Approved')),
                ('status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.status')),
            ],
        ),
    ]
